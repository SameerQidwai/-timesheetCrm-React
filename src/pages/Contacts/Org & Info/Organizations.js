...
import { Table, Menu, Dropdown, Button, Popconfirm, Row, Col,Typography, Modal, Tabs } from 'antd'
...
class Organizations extends Component {
                ...
                render: (record) => (
                    <Dropdown overlay={
                        <Menu>
                            ...
                            <Menu.Item >
                                <Link to={{ pathname: `/organizations/info/${record.key}`}} className="nav-link">
                                    View
                                </Link>
                            </Menu.Item >
                        </Menu>
    ...
    BasicCall = (vake) =>{ // this will work after  got  Object from the skill from 
        this.setState({
            mergeObj: {
                ...this.state.mergeObj,
                ...vake.obj,
            ...
            if(this.state.basicSubmitted && this.state.billingSubmitted && this.state.insuredSubmitted) { //check if both form is submittef
    ...
    BillingCall = (vake) =>{ // this will work after  getting the Object from level form
        this.setState({
            mergeObj: {
                ...this.state.mergeObj,
                ...vake.obj
    ...
    InsuredCall = (vake) =>{ // this will work after I get the Object from the form
        this.setState({
            mergeObj: {
                ...this.state.mergeObj,
                ...vake.obj
    ...
    getRecord = (data) => {
        ...
        this.setState({
            openModal:true,
            editOrg:data.key,
            BasicFields: {...this.state.BasicFields, initialValues: {obj:basic}},
            BillingFields: {...this.state.BillingFields, initialValues: {obj:billing}},
            InsuredFields: {...this.state.InsuredFields, initialValues: {obj:insured}},
        })
    }
        ...
        return(
            <>
                <Row justify="space-between">
                    ...
                    <Col style={{textAlign:'end'}} span={4} >
                        <Row justify="space-between">
                            ...
                            <Col>
                                <Button type="primary" onClick={()=>{this.setState({openModal:true})}} size='small'> <PlusSquareOutlined />Organizations</Button>
                            </Col>
                        </Row>
                    </Col>
                    <Col span={24}>
                ...
                {this.state.openModal ? 
                    <Modal
                        title= {this.state.editOrg? 'Edit Organization' : "Add New Organization"}
                        centered
                    ...
                    >
                        <Tabs type="card">
                            <TabPane tab="Basic Informantion" key="1">
                                <Form ref={this.basicRef} Callback={this.BasicCall} FormFields= {this.state.BasicFields} /> 
                            </TabPane>
                            <TabPane tab="Billing Information" key="2">
                                <Form ref={this.billingRef} Callback={this.BillingCall} FormFields= {this.state.BillingFields} /> 
                            </TabPane>
                            <TabPane tab="Insured Information" key="3">
                                <Form ref={this.insuredRef} Callback={this.InsuredCall} FormFields= {this.state.InsuredFields} /> 
                            </TabPane>
                        </Tabs>  
                    </Modal> : null
                }
